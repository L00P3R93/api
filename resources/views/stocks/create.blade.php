...
@section('title')
    <title>New Share | Kadi Kings</title>
@endsection
                            ...
                            <div class="row">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" id="user_id" name="user_id">
                                            ...
                                            @foreach($users as $user)
                                                <option {{ selected($user->id, old('user_id'), 'selected') }} value="{{$user->id}}">{{$user->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="amount" id="amount" placeholder="0.0" value="{{ old('user_id') }}" required autocomplete="off" />
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
