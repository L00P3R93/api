        ...
        <div class="wrap-login100">
            ...
            <form class="login100-form needs-validation" action="" method="POST" novalidate>
                ...
                <div class="text-center p-b-40">
                    <h1 class="h3 mb-3 font-weight-bolder">KADI KINGS</h1>
                ...
                <p class="mt-5 mb-3 text-muted text-center"><strong>Copyright &copy; {{ date('Y') }} <a href="#">KADI KINGS</a>.</strong> &nbsp;&nbsp;All rights reserved.</p>
            </form>
        </div>
    </div>
</div>
