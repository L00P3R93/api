...
use App\Http\Middleware\AuthenticateLogViewerBasicAuth;
...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Log Viewer Basic Auth
    |--------------------------------------------------------------------------
    | Credentials required by the AuthenticateLogViewerBasicAuth middleware
    | to access the Log Viewer UI and API.
    |
    */

    'basic_auth' => [
        'username' => env('LOG_VIEWER_USERNAME'),
    ...
    */
    ...
    'route_path' => env('LOG_VIEWER_ROUTE_PATH', 'internal-logs'),
    ...
    */
    ...
    'middleware' => [
        'web',
        AuthenticateLogViewerBasicAuth::class,
